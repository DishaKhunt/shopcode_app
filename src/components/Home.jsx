  ...
  return (
    <Layout>
      <div className='mx-auto md:w-10/12'>
        ...
        >
          <SwiperSlide>
            <img src="/images/b1.jpg" className='w-full h-[550px]' alt="" />
          </SwiperSlide>
          <SwiperSlide>
            <img src="/images/b2.jpg" className='w-full h-[550px]' alt="" />
          </SwiperSlide>
          <SwiperSlide>
            <img src="/images/b3.jpg" className='w-full h-[550px]' alt="" />
          </SwiperSlide>
          <SwiperSlide>
            <img src="/images/b4.jpg" className='w-full h-[550px]' alt="" />
          </SwiperSlide>
          <SwiperSlide>
            <img src="/images/b5.jpg" className='w-full h-[550px]' alt="" />
          </SwiperSlide>
      ...
      <div className="p-8 md:p-16">
        <h1 className='mb-2 font-serif text-3xl font-bold text-center'>Latest Products</h1>
